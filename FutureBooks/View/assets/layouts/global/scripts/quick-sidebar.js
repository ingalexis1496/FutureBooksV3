    ...
    var handleQuickSidebarChat = function () {
        ...
        var handleChatMessagePost = function (e) {
            ...
            var preparePost = function(dir, time, name, avatar, message) {
                ...
                tpl += '<a href="#" class="name">Victor Preciado</a>&nbsp;';
            ...
            // handle post
            var time = new Date();
            var message = preparePost('out', (time.getHours() + ':' + time.getMinutes()), "Victor Preciado", 'Avatar3', text);
            message = $(message);
            ...
            setTimeout(function(){
                var time = new Date();
                var message = preparePost('in', (time.getHours() + ':' + time.getMinutes()), "Ella Wong", 'avatar2', 'hola buenos dias eres el administrador');
                message = $(message);
                chatContainer.append(message);
